...
As an optimizer we use Adam, which is an adaptive learning rate optimization method introduced by \textcolor{red}{Kingma and Ba 2014}. Adam incorporates momentum as an estimate of the first order moment of the gradient, and it applies bias correction in response to the fact that the moments are initialized at the origin.
