...
\begin{figure}
  ...
  \caption{Actual laser measurement and predicted laser trajectory by GRU RNN with MSELoss and hyperparameters 'interval': 30, 'hidden_size': 64, and 'learning rate': 0.01.}
